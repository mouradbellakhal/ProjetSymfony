...
class UserController extends Controller
{
     ...
     * @Method({"GET", "POST"})
     */
    public function userRegisterAction(Request $request, UserPasswordEncoderInterface $passwordEncoder, EntityManagerInterface $em)
    {
     ...
     * @Method({"GET", "POST"})
     */
    public function AdminRegisterAction(Request $request, UserPasswordEncoderInterface $passwordEncoder, EntityManagerInterface $em)
    {
        $user = new User((string) Uuid::uuid4());
        ...
        return $this->render('user/adminregister.html.twig', [
            'form' => $form->createView(),
        ]);
    }
